...
import {Jumbotron , Container , Row , Col , Button , Card , CardDeck, Form , Badge} from 'react-bootstrap'
        ...
        <div className="blog-article">
            ...
            <Container fluid="sm" className="blog-article-text">
                    <p>
                        ...
                        But are people claiming?Despite these measures by DWP, new analysis conducted by the University of Salford (and funded by the Health Foundation) found that half a million (430,000–560,000) people were eligible for Universal Credit at the start of the pandemic but did not claim it. According to estimates from the study:
                        <br/><br/>
