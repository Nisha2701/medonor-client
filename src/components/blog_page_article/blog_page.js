...
class blog extends Component {
      ...
      <Row className='article-card' key={key}>
        ...
        <div>
          <Card.Body>
            ...
            <Button variant='light' size='sm' className='read-more-btn'>
              Read more
            </Button>
          </Card.Body>
        </div>
  ...
  render() {
    console.log('isLoading!', this.props.ngoBlogs);
    ...
    return (
      <div className='blogpage'>
        ...
        >
          <Container>
            ...
            <p style={{ fontSize: '2rem' }} className='blog-title-byline-by'>
              If you’re looking for positive stories of change that will make
        ...
        <Jumbotron
          className='note-jumbo'
          style={{ backgroundColor: '#DAF1F0' }}
        >
          <Container>
            <Row>
              <Col>
